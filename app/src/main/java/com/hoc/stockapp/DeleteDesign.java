...
import com.hoc.stockapp.Adapter.DeleteDesign_MyAdapter;
...
public class DeleteDesign extends AppCompatActivity implements DeleteDesign_MyAdapter.OnDesignClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.activity_delete_design);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(DeleteDesign.this,MainActivity.class);
                startActivity(i);
                finish();
            }
        });
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if(dataSnapshot.hasChildren()){
                    ...
                    DeleteDesign_MyAdapter deleteDesign_myAdapter = new DeleteDesign_MyAdapter(getApplicationContext(),arrayList);
                    recyclerView.setAdapter(deleteDesign_myAdapter);
                    deleteDesign_myAdapter.notifyDataSetChanged();

                    DeleteDesign_MyAdapter.setOnDesignClickListener(DeleteDesign.this);
                }
            }
    ...
    public void onDesignClick(int position) {
        Intent editItemIntent = new Intent(this, DeleteDesign_Confirm.class);

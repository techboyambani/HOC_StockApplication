...
public class EditDesign_MyAdapter extends RecyclerView.Adapter<EditDesign_MyAdapter.MyAdapterViewHolder> {
    ...
    public EditDesign_MyAdapter(Context c, ArrayList<DesignInformation> arrayList){
        this.c = c;
